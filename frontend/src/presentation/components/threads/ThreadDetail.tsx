        ...
        <div className="flex flex-col h-full bg-gray-50 overflow-hidden">
            ...
            <div className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-10 px-6 py-4 flex items-start justify-between">
                ...
                <div className="flex gap-2">
                    ...
                    {thread.status === 'merged' && (
                        <Button variant="secondary" disabled className="gap-2 text-purple-700 bg-purple-100">
            ...
            <div className="flex-1 flex overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-8">
                    ...
                    {/* Timeline */}
                    <div className="relative space-y-6 pl-4 border-l-2 border-zinc-200 ml-4">
                        {posts.map((post) => (
                            <div key={post.id} className="relative group">
                                {/* Avatar Bubble */}
                                <div className={cn(
                                    "absolute -left-[27px] top-0 h-10 w-10 rounded-full border-4 border-gray-50 flex items-center justify-center text-xs font-bold text-white shadow-sm z-10",
                                    post.author.avatar
                                )}>
                                    {post.author.name[0]}
                                </div>
                    ...
                    {thread.status !== 'merged' && thread.status !== 'closed' && (
                        <div className="pt-6 relative pl-4 border-l-2 border-zinc-200 ml-4">
                ...
                {/* Right: Sidebar */}
                <div className="w-80 border-l border-gray-200 bg-white/50 p-4 hidden xl:block space-y-6">
                    <div>
