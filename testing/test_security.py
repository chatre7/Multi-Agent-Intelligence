...
class TestFilePathSecurity:
    ...
    def test_save_file_allowed_extensions(self):
    ...
    def test_save_file_allowed_directories(self):
    ...
    def test_save_file_symlink_attack(self):
...
class TestJWTSecretPersistence:
    ...
    def test_jwt_secret_file_permissions(self):
    ...
    def test_jwt_secret_invalid_file_fallback(self):
    ...
    def test_auth_config_uses_persistent_secret(self):
